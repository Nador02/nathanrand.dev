      ...
      <AboutContainer>
        ...
        <ContentContainer>
            <DescriptionRow mirrored={false}>
                <Description>
                    My name is Nathan Rand and I grew up and currently reside in the small Virginia town of Round Hill. I am studying Aerospace Engineering at Virginia Tech in Blacksburg, VA. <br/> <br/> 
            ...
            <DescriptionRow mirrored={true}>
                ...
                Another program I am apart of involves running Virginia Tech's Engineering Volleyball League, where each Engineering major plays it off in a college wide tournament. This has been a great opportunity for me to meet people from a variety of backgrounds and have some good fun leading Aerospace to the finals in 2022 (and hopefully a championship title in Spring 2023)!
                </Description>
            </DescriptionRow>
        </ContentContainer>
