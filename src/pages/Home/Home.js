...
export const Home = () => {
  ...
  return (
    <HomeContainer>
      ...
      <PlanetRow topTextContent="Over the Summer of 2022 I worked on..." middleTextContent="NASA FORECAT" bottomTextContent="Oh Boom Rocket go boom lol I make rocket." mirrored={true} planet={ForecatPlanet} buttonContent="Toggle Retro Boosters for Re-Entry" buttonPath="/about" isProject={true}></PlanetRow>
      <PlanetRow topTextContent="Another Project I worked on in the Summer of 2022 was..." middleTextContent="Sequoia Canopy" bottomTextContent="Teehee I made silly little website with Angular :P" planet={SequoiaPlanet} buttonContent="Prepare the Jump Drives" buttonPath="/about" isProject={true}></PlanetRow>
      <PlanetRow topTextContent="Something I am currently involved with is..." middleTextContent="Banavity" bottomTextContent="Banana company Banana company lololol" mirrored={true} planet={BanavityPlanet} buttonContent="Buckle Your Seatbelts!" buttonPath="/about" isProject={true}></PlanetRow>
      <FooterContainer>
